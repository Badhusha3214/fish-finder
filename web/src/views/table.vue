<template>
  ...
  <table class="min-w-full divide-y divide-gray-200">
    <tbody class="divide-y divide-gray-200">
      <tr
        v-for="(vernacularName, index) in entry.vernacularNames"
        :key="index"
        class="text-xs"
      >
        ...
        <td class="py-1">{{ vernacularName.name }}</td>
                ...
                <td class="py-3 px-4 text-center">
                  <div class="flex justify-center space-x-2">
                    <img
                      v-for="(img, imgIndex) in entry.images.slice(0, 1)"
                      :key="imgIndex"
                      :src="img"
                      :alt="`${entry.scientificName} ${imgIndex + 1}`"
      ...
      >
        <div
          class="relative mx-auto p-8 border border-gray-300 w-full max-w-3xl shadow-lg rounded-lg my-8 bg-white"
        >
          ...
          <form
            ...
            class="space-y-6 max-h-[calc(100vh-10rem)] overflow-y-auto"
          >
            <div class="space-y-5">
              ...
              <div class="space-y-2">
                <div
                  v-for="(name, index) in vernacularNames"
                  :key="index"
            ...
            <div
              class="flex flex-col sm:flex-row items-center justify-end space-y-3 sm:space-y-0 sm:space-x-4 mt-8"
            >
              <button
                @click="closeModal"
                type="button"
...
export default {
  ...
  methods: {
    ...
    editEntry(index) {
      ...
      this.vernacularNames = Object.entries(entry.vernacularNames).map(
