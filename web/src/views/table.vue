  ...
  <DashboardLayout>
    <div class="min-h-screen bg-white rounded-lg">
        ...
        <div class="overflow-x-auto rounded-lg">
          <table class="w-full bg-white shadow-md rounded">
            ...
            <tbody class="text-black bg-btn bg-opacity-10 text-sm font-light">
              <tr v-for="(entry, index) in filteredEntries" :key="entry.item_id" class="odd:bg-white hover:bg-btn hover:bg-opacity-30">
      ...
      <div class="space-y-5">
        ...
        <div class="flex space-x-4">
          <div class="flex-1">
            ...
            <input @change="handleFileUpload($event, 'image')" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200" id="image" type="file" accept="image/*" :required="editIndex === null">
          </div>
          <div class="flex-1">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-end space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
        <button @click="closeModal" type="button" class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-black bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          Cancel
        </button>
        <button type="submit" class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
