...
<template>
    ...
    <div class="flex flex-col relative gap-6 w-full h-full">

        <div class="absolute -z-10 w-screen h-screen fixed">
            <img class="w-full h-full" src="/img/background.png" alt="">
        </div>

        <div class="p-5 flex-shrink-0">
      <div class="flex items-center justify-between w-full fixed top-0 left-0 right-0 p-5 bg-transparent">
        <button class="flex items-center text-primary rounded-full cursor-pointer" @click="openSidebar">
    ...
    <div
        ...
        "
        :class="{ 'opacity-100 z-40': isOpen, 'opacity-0 -z-10': !isOpen }"
        @click="closeSidebar"
    >
