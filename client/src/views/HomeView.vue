    ...
    <transition name="slide" mode="out-in">
      <div class="flex flex-col h-full w-full overflow-y-auto">
        ...
        <div class="w-full mt-4 relative swiper-container">
          <swiper :slides-per-view="1.4" :centered-slides="true" :loop="false" :space-between="5"
            :pagination="{ clickable: true, el: '.swiper-pagination' }" @slideChange="onSlideChange" :modules="modules"
            class="mySwiper">
            <swiper-slide v-for="(category, index) in categories" :key="category.id">
              <div class="slide-content">
                <div class="relative flex flex-col mt-4 w-full h-full touch-manipulation" @click="openPage(category)">
                  <img :src="category.image" :alt="category.title" :key="category.id"
        ...
        <div class="relative flex flex-col w-full mt-10 mb-6">
          ...
          <div class="absolute left-0 top-0 -z-10 w-full h-full flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="316" height="78" viewBox="0 0 316 78" fill="none">
              ...
              <defs>
                <filter id="filter0_d_72_187" x="0.5" y="0" width="315" height="77.5714" filterUnits="userSpaceOnUse"
                ...
                <linearGradient id="paint0_linear_72_187" x1="2" y1="46.2857" x2="307" y2="46.2857"
